            ...
            <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                <div className="md:flex md:justify-between">
                    <div className="mb-6 md:mb-0">
                        <Link to="/" className="flex items-center">
                            <img
                                src="https://cdn.freelogovectors.net/wp-content/uploads/2022/05/asus_rog_logo_freelogovectors.net_.png"
                                className="mr-3 h-16"
                                alt="Logo"
                            />
                        </Link>
                    ...
                    <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                        ...
                        <div>
                            ...
                            <ul className="text-gray-500 font-medium">
                                <li className="mb-4">
                                    <a
                                        href="https://github.com/Abhisek250603"
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm text-gray-500 sm:text-center">
                        ©
                        <a href="https://abhisekpraharaj246@gmail.com/" className="hover:underline">
                            abhisekpraharaj
                        </a>
                        . All Rights Reserved.
                    </span>
